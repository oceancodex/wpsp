            ...
            <div class="meta-box-sortables ui-sortable">
                <div class="postbox">
                    ...
                    <div class="postbox-header">
                        <h2 class="hndle ui-sortable-handle"><?php echo wpsp_trans('messages.settings') ?></h2>
                    ...
                    <div class="inside form-table w-auto">
                        ...
                        <div class="input-group mt-2 mb-3">
                            <label for="settings[setting_1]">
                                <?php echo wpsp_trans('messages.title') ?>:
                ...
                <button type="submit" class="button button-primary"><?php echo wpsp_trans('messages.save_changes') ?></button>
            </div>
        </div>
    </div>
</form>