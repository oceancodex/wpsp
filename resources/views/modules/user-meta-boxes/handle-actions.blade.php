<div class="handle-actions hide-if-no-js">
    ...
    <span class="hidden" id="wpsp_shortcode-handle-order-higher-description">Chuyển {{ $id }} lên trên</span>
    ...
    <span class="hidden" id="wpsp_shortcode-handle-order-lower-description">Chuyển {{ $id }} xuống dưới</span>
    <button type="button" class="handlediv" aria-expanded="true">
        <span class="screen-reader-text">Chuyển đổi bảng điều khiển: {{ $id }}</span>
