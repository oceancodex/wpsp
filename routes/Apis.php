...
//			Route::post('get', [ApisController::class, 'getApiToken'])->name('get');
			Route::post('test', [ApisController::class, 'testApiToken'], [
				'namespace' => 'xxx', 'version' => 'v2'
			])->middleware(ApiTokenAuthentication::class)->name('test');
		});
...
//				Route::post('users/(?P<id>\d+)/update', [ApisController::class, 'usersUpdate'])->name('update');
//			});
//		});
//
