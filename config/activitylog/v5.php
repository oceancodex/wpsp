...
return [
	 ...
	 */
	'enabled' => env('WPSP_ACTIVITYLOG_ENABLED', true),
	 ...
	 */
	'activity_model' => \WPSP\App\Widen\Integrations\ActivityLog\V5\Models\ActivityLogModel::class,
	 ...
	 */
	'buffer' => [
		'enabled' => env('WPSP_ACTIVITYLOG_BUFFER_ENABLED', false),
	],
