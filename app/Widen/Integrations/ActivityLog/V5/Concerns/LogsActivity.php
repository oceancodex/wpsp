...
use WPSP\App\Widen\Integrations\ActivityLog\V5\Support\ActivityLogger;
use WPSP\App\Widen\Integrations\ActivityLog\V5\Support\ActivityLogStatus;
...
trait LogsActivity {
	...
	protected static function bootLogsActivity(): void {
		static::eventsToBeRecorded()->each(function(string $eventName) {
			...
			static::$eventName(function(Model $model) use ($eventName) {
				...
				Funcs::app(ActivityLogger::class)
	...
	public function getLogNameToUse(): ?string {
		return $this->activitylogOptions->logName
			?? Funcs::config('activitylog.default_log_name');
	}
	...
	protected function excludedAttributes(): array {
		return array_merge(
			...
			Funcs::config('activitylog-v5.default_except_attributes', [])
		);
	}
