...
//		}
	...
	public function afterLoadAdminPage($adminPage) {
		if (in_array($this->currentTab, ['table'])) {
			$this->table = new \WPSP\App\WP\ListTables\Settings();
		}
		elseif (in_array($this->currentTab, ['roles'])) {
			$this->table = new \WPSP\App\WP\ListTables\Roles();
//			$this->table = new \WPSP\App\WP\ListTables\WPRoles();
		}
		elseif (in_array($this->currentTab, ['permissions'])) {
			$this->table = new \WPSP\App\WP\ListTables\Permissions();
//			$this->table = new \WPSP\App\WP\ListTables\WPCapabilities();
		}
		elseif (in_array($this->currentTab, ['users'])) {
			$this->table = new \WPSP\App\WP\ListTables\Users();
		}
	}
